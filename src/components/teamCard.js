...
function TeamCard({name, about, desig, department, src, email, linkedin }) {
    return (
        <div className="group flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
            ...
            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
                ...
                <a rel="noopener noreferrer" href={`mailto:${email}`} title="Email" className="dark:text-gray-900 hover:dark:text-violet-400">
                ...
                <a rel="noopener noreferrer" href={linkedin} target="_blank" title="LinkedIn" className="dark:text-gray-900 hover:dark:text-violet-400">
