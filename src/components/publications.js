      ...
      <div className="container grid gap-5 p-5 mx-auto lg:grid-cols-2 xl:grid-cols-3">
        {
          publications.reverse().map(item =>
            ...
            <div d={item.num} className="group rounded-xl flex flex-col md:flex-row  items-center p-2 bg-gray-900 text-gray-100 space-y-3 space-x-3 hover:-translate-y-3 transition-all">
              ...
              <div className="flex flex-col justify-between">
                ...
                <a rel="noopener noreferrer" href={item.link} target="_blank" className="inline-flex items-center py-2 space-x-2 text-xs dark:text-violet-400 group-hover:translate-x-3">
